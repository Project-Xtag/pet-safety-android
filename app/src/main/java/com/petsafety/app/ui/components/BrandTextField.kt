 ...
 * Features:
 * - Optional leading icon with muted color
 * - 16pt horizontal padding, 14pt vertical padding
 * - 14pt corner radius
 * - Border color matching iOS systemGray4
 */
@Composable
fun BrandTextField(
    value: String,
...
/**
 * Multiline text field for longer inputs like notes.
 */
@Composable
fun BrandTextArea(
    value: String,
