...
data class Order(
    ...
    @Serializable(with = FlexibleDoubleSerializer::class) @SerialName("total_amount") val totalAmount: Double,
    @Serializable(with = FlexibleDoubleSerializer::class) @SerialName("shipping_cost") val shippingCost: Double,
...
data class OrderItem(
    ...
    val quantity: Int,
    @Serializable(with = FlexibleDoubleSerializer::class) val price: Double,
